...
export const PolicyList: TermsProps[] = [
  {
    title: '1. 개인정보 수집목적 및 이용목적',
    content: '회원가입 시 입력받는 선택 항목의 이용 목적 기재 (예시 : 맞춤형 콘텐츠 추천 및 마케팅 활용)',
  },
  {
    title: '2. 수집하는 개인정보 항목',
    content: '회원가입 시 입력받는 선택 항목 기재 (예시: 생년월일, 성별)',
  },
  {
    title: '3. 개인정보의 보유기간 및 이용기간',
    content: '회원탈퇴 또는 회원정보 수정을 통해 해당 항목 삭제 시 지체없이 파기합니다.',
  },
];

export const TermsList: TermsProps[] = [
  {
    title: '1조(목적)',
    content:
      '이 약관은 교보정보통신(주) (전자상거래 사업자)가 운영하는 교보기업몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.\n' +
  ...
  },
  {
    ...
    content:
      ...
      '6. 결제방법의 선택\n' +
      '② “몰”이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시 ' +
      '구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, ' +
      '제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유‧이용 기간 등을 구매자에게 명시하여야 합니다. ' +
      '다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 ' +
  ...
  },
  {
    ...
    content:
      ...
      '제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화' +
      ...
      '3. 시간의 경과에 의하여 재화 등의 가치가 현저히 감소한 경우\n' +
      '4. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본인 재화 등의 포장을 훼손한 경우\n' +
      '5. 기타 재화 등의 이용자의 귀책사유로 인하여 재화 등이 훼손되거나 멸실된 경우\n' +
      '③ 제2항제2호 내지 제5호의 경우에 “몰”은 반품 및 교환을 제한할 수 있습니다.',
  },
  {
    title: '제16조(청약철회 등의 효과)',
    content:
      '① “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다. 이 ' +
      '경우 “몰”이 이용자에게 재화등의 환급을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 ' +
  ...
  },
  {
    ...
    content:
      '① “몰”이 작성한 저작물에 대한 저작권과 기타 지적재산권은 “몰”에 귀속합니다.\n' +
      '② 이용자는 “몰”을 이용함으로써 얻은 정보를 “몰”의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 ' +
